...
@section('content')
    ...
    <div class="flex justify-center my-2">
        <div class="w-full max-w-md">
            <form action="#" class="bg-white shadow-md text-sm mb-4 pb-8 px-4">
                <div class="mb-4">
                    <label for="email" class="block text-grey-darker font-bold mb-2 px-3 py-3">Email</label>
                    <input id="email" type="text" name="email" placeholder="Email here" class="shadow border appearance-none rounded w-full text-grey px-1 py-1">
                </div>
                <div class="mb-4">
                    <label for="password" class="block text-grey-darker font-bold mb-2">Password</label>
                    <input id="password" type="password" name="password" placeholder="Password here" class="shadow border appearance-none rounded w-full text-grey">
                    <p class="text-red mt-2 text-sm">* Password is required</p>
                </div>
                <div class="flex items-center justify-between">
                    <button class="mt-3 rounded font-bold bg-blue-dark text-white hover:bg-blue-darker px-2 py-2 shadow">Login</button>
    ...
    <div class="flex justify-center my-2">
        <div class="w-full max-w-sm rounded shadow-lg bg-white">
            <img alt="Text alternatiu" src="img/example.jpg" alt="" class="rounded-t w-full">
            <div class="px-6 py-4">
